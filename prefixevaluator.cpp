...
int main()
{
    ...
    cout << "*****************" << endl;
    cout << "Expression After Removing Spaces & Replacing ( Negative , Triagometric Functions ) : " << endl;
    cout << "=> " << token << endl;
    Exp *prefixExp = strToExp(token);
    string prefix;
    prefix += prefixExp->print();
    cout << "*****************" << endl;
    cout << "Prefix Expression : " << endl;
    cout << "=> " << prefix << endl;
    if (prefix.find("Expression is Wrong") != std::string::npos)
    {
    ...
    if (tokens.size())
    {
        cout << "Evaluation of Expression : " << token << endl;
